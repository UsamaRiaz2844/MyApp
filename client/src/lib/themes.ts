...
export const CHAT_THEMES: ChatTheme[] = [
  ...
  },
  {
    ...
    icon: '☕',
    scene: 'cafe',
    swatch: 'linear-gradient(135deg,#7a5238,#caa15b)',
    bgLight: 'linear-gradient(180deg,#5a3b2a,#7a5238)',
    bgDark: 'linear-gradient(180deg,#2a1c12,#3a281a)',
    mine: 'bg-amber-700/88 text-amber-50 backdrop-blur-md',
    theirs: 'bg-amber-50/85 text-stone-900 backdrop-blur-md dark:bg-white/12 dark:text-white',
    accent: 'bg-gradient-to-br from-amber-400 to-amber-700 text-amber-50',
    mineMeta: 'text-amber-100/70',
  },
  {
    id: 'office',
    label: 'Office',
    ...
    icon: '💼',
    scene: 'office',
    swatch: 'linear-gradient(135deg,#556274,#8fd0ff)',
    bgLight: 'linear-gradient(180deg,#3a4658,#556274)',
    bgDark: 'linear-gradient(180deg,#1c232e,#2a333f)',
    mine: 'bg-blue-600/88 text-white backdrop-blur-md',
    theirs: 'bg-white/85 text-slate-900 backdrop-blur-md dark:bg-white/12 dark:text-white',
    accent: 'bg-gradient-to-br from-sky-500 to-blue-600 text-white',
    mineMeta: 'text-white/75',
  },
  {
    id: 'library',
    ...
    icon: '📚',
    scene: 'library',
    swatch: 'linear-gradient(135deg,#5b3f2a,#c9a24a)',
    bgLight: 'linear-gradient(180deg,#5b3f2a,#4a3221)',
    bgDark: 'linear-gradient(180deg,#241a10,#301f12)',
    mine: 'bg-amber-800/90 text-amber-50 backdrop-blur-md',
    theirs: 'bg-amber-50/85 text-stone-900 backdrop-blur-md dark:bg-white/12 dark:text-white',
    accent: 'bg-gradient-to-br from-amber-500 to-amber-800 text-amber-50',
    mineMeta: 'text-amber-100/70',
  },
  {
    id: 'gym',
    ...
    icon: '🏋️',
    scene: 'gym',
    swatch: 'linear-gradient(135deg,#3c424b,#c0392b)',
    bgLight: 'linear-gradient(180deg,#2b2f36,#3c424b)',
    bgDark: 'linear-gradient(180deg,#17191d,#24272d)',
    mine: 'bg-red-600/90 text-white backdrop-blur-md',
    theirs: 'bg-slate-200/85 text-slate-900 backdrop-blur-md dark:bg-white/12 dark:text-white',
    accent: 'bg-gradient-to-br from-red-500 to-rose-700 text-white',
    mineMeta: 'text-white/75',
  },
  {
    id: 'space',
    ...
    icon: '🚀',
    scene: 'space',
    swatch: 'linear-gradient(135deg,#160a2e,#7ad0ff)',
    bgLight: 'linear-gradient(180deg,#160a2e,#05030f)',
    bgDark: 'linear-gradient(180deg,#0a0518,#05030f)',
    mine: 'bg-violet-600/85 text-white backdrop-blur-md border border-cyan-300/30',
    theirs: 'bg-white/12 text-white backdrop-blur-md border border-white/15',
    accent: 'bg-gradient-to-br from-cyan-400 to-violet-600 text-white',
  ...
  },
  {
    ...
    icon: '🌆',
    scene: 'rooftop',
    swatch: 'linear-gradient(135deg,#0e1a3a,#7b3f6b)',
    bgLight: 'linear-gradient(180deg,#0e1a3a,#7b3f6b)',
    bgDark: 'linear-gradient(180deg,#0a1128,#3a2036)',
    mine: 'bg-amber-500/88 text-stone-900 backdrop-blur-md',
    theirs: 'bg-white/14 text-white backdrop-blur-md border border-white/15',
    accent: 'bg-gradient-to-br from-amber-300 to-fuchsia-500 text-stone-900',
    mineMeta: 'text-stone-900/60',
  },
  {
    id: 'rain',
    ...
    icon: '🌧️',
    scene: 'rain',
    swatch: 'linear-gradient(135deg,#6b7a8c,#cddcec)',
    bgLight: 'linear-gradient(180deg,#3a4658,#6b7a8c)',
    bgDark: 'linear-gradient(180deg,#1c232e,#2c3440)',
    mine: 'bg-sky-700/88 text-white backdrop-blur-md',
    theirs: 'bg-white/85 text-slate-900 backdrop-blur-md dark:bg-white/12 dark:text-white',
    accent: 'bg-gradient-to-br from-sky-500 to-slate-600 text-white',
    mineMeta: 'text-white/75',
  },
  {
    id: 'snow',
    ...
    icon: '❄️',
    scene: 'snow',
    swatch: 'linear-gradient(135deg,#4a6a8f,#e8f2fa)',
    bgLight: 'linear-gradient(180deg,#4a6a8f,#bcd4e6)',
    bgDark: 'linear-gradient(180deg,#16283a,#22384d)',
    mine: 'bg-sky-500/88 text-white backdrop-blur-md',
    theirs: 'bg-white/88 text-slate-900 backdrop-blur-md dark:bg-white/14 dark:text-white',
    accent: 'bg-gradient-to-br from-sky-300 to-blue-500 text-white',
    mineMeta: 'text-white/75',
  },
];
